...
const CTA = (props) => {
  ...
  return (
    <div className='bg-main flex flex-col gap-5 text-center text-white'>
        ...
        <Sub className='text-[17px] md:text-[18px] font-light'>Fylo stores all your most important files in<br className='md:hidden block'/> one secure location.<br className='hidden md:block'/> Access them wherever<br className='md:hidden block'/>you need, share and collaborate with<br className='hidden md:block'/> friends<br className='md:hidden block'/> family, and co-workers.</Sub>
